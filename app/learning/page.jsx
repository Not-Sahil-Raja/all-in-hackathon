          ...
          <div className="flex flex-col justify-center space-y-4">
            <div className="space-y-2">
              ...
              <p className="max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400">
                Access a world-class education from the comfort of your home,
        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
              Dive into a curated collection of practice problems, organized by
              subject and difficulty level. Hone your skills and prepare for
              success.
            </p>
          </div>
        </div>
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 sm:grid-cols-2 md:grid-cols-3 lg:gap-12">
          <Card>
            <CardContent className="flex flex-col gap-2">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Practice your algebra skills by solving for the unknown
                variable.
              </p>
          ...
          <Card>
            <CardContent className="flex flex-col gap-2">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Test your knowledge of the periodic table by identifying
          ...
          <Card>
            <CardContent className="flex flex-col gap-2">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Challenge your historical knowledge by placing key events in the
        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 sm:grid-cols-2 md:grid-cols-3 lg:gap-12">
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Learn the fundamental concepts of algebra, including variables,
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Dive into the historical events and social changes that shaped
        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 sm:grid-cols-2 md:grid-cols-3 lg:gap-12">
          <Card>
            <CardContent className="space-y-2">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                A comprehensive workbook covering essential math concepts, with
          ...
          <Card>
            <CardContent className="space-y-2">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Detailed notes on the key topics in biology, perfect for review
