...
* @see https://v0.dev/t/VnXnp2JupD0
...
export function uploadEdu() {
  return (
    (<main key="1" className="container mx-auto py-12 px-4 md:px-6 lg:px-8">
      <header className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight">Manage Educational Content</h1>
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-lg font-medium">The History of the Solar System</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Explore the fascinating origins and evolution of our solar system.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-medium">Introduction to Photosynthesis</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400">
        ...
        <div
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Test your understanding of algebraic concepts with these practice problems.
              </p>
            </div>
            <div>
      ...
      <section
        className="mt-12 rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-950">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-xl font-bold">Video Lessons</h2>
          <Button size="sm">Add Video</Button>
        </div>
        <div
          ...
          <div
            ...
            <img
              ...
              width={300} />
            <h3 className="text-lg font-medium">Fractions and Decimals</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">Learn how to work with fractions and decimals.</p>
          </div>
          <div
            className="rounded-md border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-950">
            <img
            ...
            <TabsContent value="text">
              <form className="grid gap-6">
                ...
                <div>
                  ...
                  <Textarea className="min-h-[200px]" id="text-content" placeholder="Enter content" />
                </div>
                <Button className="w-full" type="submit">
                  Add Text Lesson
                </Button>
